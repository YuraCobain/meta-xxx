...
do_install( ) {
    ...
    install -d ${D}${libdir}/webrtc/modules/audio_coding
    install -m 0644 obj/modules/audio_coding/*.a ${D}${libdir}/webrtc/modules/audio_coding/

    install -d ${D}${libdir}/webrtc/modules/video_coding
    install -m 0644 obj/modules/video_coding/*.a ${D}${libdir}/webrtc/modules/video_coding/
